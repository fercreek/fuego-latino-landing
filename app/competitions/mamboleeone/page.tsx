...
export default function MamboleeOnePage() {
  ...
  const accordionItems = [
    ...
    {
      id: "redes-sociales",
      title: "🌐 Redes Sociales de Mambolee One",
      defaultOpen: true,
      content: (
        <div className="space-y-4 sm:space-y-6">
          <p className="text-base sm:text-lg text-foreground/70">
            Te facilito los enlaces oficiales de las redes sociales de Mambolee One para que puedas estar al día con toda la información del evento:
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link
              href="https://www.mamboleeone.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center justify-center gap-3 p-5 sm:p-6 rounded-xl bg-gradient-to-br from-flame-500/20 to-flame-600/10 border-2 border-flame-500/40 hover:border-flame-500/60 hover:bg-flame-500/30 transition-all min-h-[120px]"
            >
              <svg className="w-8 h-8 sm:w-10 sm:h-10 text-flame-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
              </svg>
              <span className="text-base sm:text-lg font-semibold text-flame-100 text-center">Página Web</span>
            </Link>
            <Link
              href="https://www.facebook.com/MamboleeONE"
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center justify-center gap-3 p-5 sm:p-6 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/10 border-2 border-blue-500/40 hover:border-blue-500/60 hover:bg-blue-500/30 transition-all min-h-[120px]"
            >
              <svg className="w-8 h-8 sm:w-10 sm:h-10 text-blue-300" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
              <span className="text-base sm:text-lg font-semibold text-blue-200 text-center">Facebook</span>
            </Link>
            <Link
              href="https://www.instagram.com/mamboleeone"
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center justify-center gap-3 p-5 sm:p-6 rounded-xl bg-gradient-to-br from-pink-500/20 to-pink-600/10 border-2 border-pink-500/40 hover:border-pink-500/60 hover:bg-pink-500/30 transition-all min-h-[120px]"
            >
              ...
              <span className="text-base sm:text-lg font-semibold text-pink-200 text-center">Instagram</span>
            </Link>
          </div>
        </div>
      ),
